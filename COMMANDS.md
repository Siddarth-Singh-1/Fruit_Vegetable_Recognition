...
Edit `local/run_app.py` and change `7860` to another number like `8080`

### Use your own dataset
1. Put images in `dataset/train/` folder
2. Organize by class (one folder per fruit/vegetable)
3. Do the same for `dataset/validation/`
4. Run training
...
```bash
python -c "import os; print('Classes:', len(os.listdir('dataset/train')))"
```
Should show 36 for the full dataset
